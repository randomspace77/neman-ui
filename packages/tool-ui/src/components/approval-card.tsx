  ...
  return (
    ...
    >
      <CardHeader>
        ...
        {danger && !isReceipt && (
          <div className="flex items-center gap-2 mt-2 rounded-[10px] bg-destructive/5 px-3 py-2 text-label-primary-bold text-destructive border border-destructive/15">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden="true">
