...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "peer group/switch inline-flex shrink-0 items-center rounded-full transition-all duration-300 outline-none disabled:cursor-not-allowed disabled:opacity-50",
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          "data-[state=checked]:data-[size=default]:translate-x-[18px] data-[state=checked]:data-[size=sm]:translate-x-[14px] data-[state=unchecked]:translate-x-0",
